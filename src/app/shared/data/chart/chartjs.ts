...
export var doughnutChartColors: any[] = [{ backgroundColor: ["#08319b", "#1ea6ec", "#FF5370"] }];
...
export var ploarChartColors: any[] = [{ backgroundColor: ["#08319b", "#1ea6ec", "#22af47", "#007bff", "#ff2046"] }];
